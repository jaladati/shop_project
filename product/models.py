...
class Product(models.Model):
    ...
    off = models.DecimalField(
        max_digits=6, decimal_places=2, default=0, validators=[MaxValueValidator(100.0), MinValueValidator(0.0)], verbose_name="تخفیف")
    ...
    def stock_count(self):
        return self.color_variant.all().aggregate(Sum("stock_count"))['stock_count__sum']
