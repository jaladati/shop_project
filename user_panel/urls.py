...
urlpatterns = [
    ...
    path("lists/add-product-to-list/", views.add_product_to_list, name="add_product_to_list"),
    path("lists/remove-product-from-list/", views.remove_product_from_list, name="remove_product_from_list"),
